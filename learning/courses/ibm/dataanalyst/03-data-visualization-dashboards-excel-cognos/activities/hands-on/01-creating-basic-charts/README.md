...
4. In the list, only select **Toyota** and click **OK**.
   ...
   <img src="./A4.png" alt="Image of Selecting Filters" style="width:30%;">

5. Select column B, then hold **SHIFT** and select column C.

   <img src="./A5.png" alt="Image of Selecting Columns" style="width:40%;">

6. On the Charts group of the Insert tab, click **Column Chart** and choose **Clustered Column** from the 2-D Column category.

   <img src="./A6.png" alt="Image of Selecting Clustered Column Chart" style="width:40%;">
...
8. On the Labels group of the Chart tab, click **Chart Title** and select **Edit Chart Title…**.
   ...
   <img src="./A8.png" alt="Image of Editing Chart Title" style="width:40%;">
...
10. Your chart should look something like the one below:
    ...
    <img src="./A10.png" alt="Example of Final Clustered Column Chart" style="width:40%;">
...
5. On the Charts group of the Insert tab, click **Area Chart** and choose **Area** from the 2-D Area category.
   ...
   <img src="./B5.png" alt="Image of Selecting Area Chart" style="width:40%;">
...
9. On the right side menu bar Format, select Series "Unit Sales" > **Fill** > **Gold, Accent 4**.
   ...
   <img src="./B9.png" alt="Image of Formatting Data Labels" style="width:40%;">

10. Your chart should look something like the one below:

    <img src="./B10.png" alt="Example of Final Area Chart" style="width:40%;">
...
2. Click the filter drop-down in column A, and select **Manufacturer** > **Filter…**.
   ...
   <img src="./2A2.png" alt="Image of Filtering Pivot Tables Rows" style="width:40%;">
...
8. Your chart should look something like the one below:
   ...
   <img src="./2A8.png" alt="Example of Final Clustered Bar Chart" style="width:40%;">
