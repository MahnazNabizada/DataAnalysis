-- DROP unnecessary COLUMNs after importing
ALTER TABLE Movies DROP COLUMN field12;
ALTER TABLE Movies DROP COLUMN field13;
ALTER TABLE Movies DROP COLUMN field14;
ALTER TABLE Movies DROP COLUMN field15;
ALTER TABLE Movies DROP COLUMN field16;
...
SELECT rev_name FROM Movies WHERE rev_stars is NULL
