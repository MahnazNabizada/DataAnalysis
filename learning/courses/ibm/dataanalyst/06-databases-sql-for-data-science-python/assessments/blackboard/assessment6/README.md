...
## 4. \***\*\_\_\_\*\*** removes all rows from a table without logging the individual row deletions.
...
## 7. If you don't specify ASC or DESC after a SQL ORDER BY clause, the following is used by default **\*\***\_\_**\*\***
...
## 9. What is the purpose of the SQL AS clause?
...
## 12. The UPDATE SQL clause can **\*\***\_**\*\***
...
## 13. The UNION SQL clause can be used with **\*\***\_**\*\***
...
## 16. Which of the following commands makes the updates performed by the transaction permanent in the database?
...
## 17. Find the name of those cities with temperature and condition whose condition is either sunny or cloudy but temperature must be greater than 70.
...
## 18. Find all the cities with temperature, condition and humidity whose humidity is in the range of 63 to 79.
...
## 20. How can you insert a new row into the "STORE" table?
...
## 22. Which of the following commands should be used to create a database named "student"?
...
## 23. A row of relation is generally referred to as ……….. and column of a relation is …………
...
## 24. \***\*\_\*\*** is the attribute or group of attributes that uniquely identify occurrence of each entity.
...
## 25. A non-key attribute, whose values are derived from primary key of some other table.
...
## 26. What type of join is needed when you wish to include rows that do not have matching values?
...
## 27. The following SQL command is which type of join?
...
## 28. Which join refers to join records from the right table that have no matching key in the left table are included in the result set:
...
## 29. Which of the following conditions has to be satisfied for INNER JOIN to work?
...
## 30. Which of the following statements is TRUE about FULL OUTER JOIN created on two tables Table1 and Table2?
...
## 31. Which of the following statements are False? Choose all that apply
...
## 32. True/False: You can drop the OUTER keyword and just say LEFT JOIN or RIGHT JOIN or FULL JOIN.
...
## 33. Below two tables (A & B) are given:
...
## 34. `Select ID, GPA from student grades order by GPA ____________` — In order to give only 10 rank on the whole we should use.
...
## 35. Refer to the following table and answer the question:
...
## 36. In the SQL given below there is an error. Identify the error.
...
## 37. SQL view is said to be updatable (that is, inserts, updates or deletes can be applied on the view) if which of the following conditions are satisfied by the query defining the view?
...
## 38. Consider the two relations instructor and department:
...
## 39. This query does which of the following operation?
...
## 40. Aggregate functions can be used in the select list or the **\_\_** clause of a select statement or subquery. They cannot be used in a **\_\_** clause.
...
## 41. If we want to eliminate duplicates, we use the keyword **\_\_** in the aggregate expression.
...
## 42. What is the meaning of "GROUP BY" clause in SQL?
...
## 43. A \***\*\_\*\*** consists of a sequence of query and/or update statements.
...
## 44. In order to maintain the consistency during transactions, database provides
...
## 45. In case of any shut down during transaction before commit which of the following statement is done automatically?
...
## 48. Nesting level of a stored procedure's execution is stored in the \***\*\_\*\*** function.
...
## 49. Which of the following is a property of transactions?
...
## 50. Constraint checking can be disabled in existing **\*\***\_\_\_**\*\*** and **\*\***\_**\*\*** constraints so that any data you modify or add to the table is not checked against the constraint.
