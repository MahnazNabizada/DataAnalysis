...
1. **Which is the best definition of Generative AI?**
   ...
   - [ ] Generative AI is exclusively designed for recognizing and classifying objects in images or videos.
...
2. **How does Generative AI solve the challenge of limited data availability?**
   ...
   - [ ] It focuses on optimizing algorithms for smaller data sets.
...
3. **How does Generative AI help in creating interactive visualizations and storytelling?**
   ...
   - [ ] It has no role in creating interactive visualizations and storytelling, as it is primarily focused on data analysis and pattern recognition.
...
4. **DataRobot uses which Generative AI technique to provide comprehensive training data?**
   ...
   - [ ] Storytelling
   - [ ] Visualization
   - [x] Augmentation to create synthetic data points
